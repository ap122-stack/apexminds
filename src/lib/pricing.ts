...
export const BUNDLES: Bundle[] = [
  ...
  { sku: "test_prep_4", tier: "test_prep", tierLabel: "Test Prep", name: "4-session bundle", sessions: 4, price: 267, walkInRate: 80, hourlyRate: 67, savings: 53 },
  { sku: "test_prep_8", tier: "test_prep", tierLabel: "Test Prep", name: "8-session bundle", sessions: 8, price: 533, walkInRate: 80, hourlyRate: 67, savings: 107, featured: true },
  { sku: "test_prep_12", tier: "test_prep", tierLabel: "Test Prep", name: "12-session bundle", sessions: 12, price: 800, walkInRate: 80, hourlyRate: 67, savings: 160 },
